...
struct BottomCardView: View {
    var body: some View {
        VStack (spacing: 20) {
            ...
            Text("This certificate is proof that Theophilus Chidiebere Okoye has achieved the UI Design Course with approval from a Design+Code Instructor")
